...
Compatible with LangChain 1.2.7+ (New Architecture)
"""
...
from langchain.agents import create_agent  # This is what's available in 1.2.7!
...
def get_place_details(place_name: str, city: str) -> str:
    ...
    Args:
        place_name: Name of attraction (e.g., "CN Tower")
...
def main():
    ...
    print("=" * 80)
    print("Michael Zhang's Travel Planning Agent (LangChain 1.2.7)")
    print("=" * 80)
    print()
    ...
    # System prompt
    system_message = """You are Michael Zhang's travel planning assistant.
...
Griffin Museum of Science and Industry;12pm-1pm
"""
